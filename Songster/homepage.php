...
<html lang="en">
   <head>
      ...
      <title>Songster - Online Music</title>
   ...
   <body class="bg-light">
      <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
         ...
         <div class="navbar-collapse offcanvas-collapse" id="nav">
            <ul class="navbar-nav ml-auto">
               <li class="nav-item">
                  <a class="nav-link active" href="homepage.php#top" id="home">Home <span class="sr-only">(current)</span></a>
               </li>
               <li class="nav-item">
      ...
      <main role="main">
         <div class ="container">
            <section id="top" class="jumbotron top-section flex flex-column full-width text-center my-0 home-img">
               <div class="container">
                  <h1 class="jumbotron-heading">
                     <?php
                        echo "Hello ".$Username ." !";
                        ?>
                     Welcome to Online Music!
                  </h1>
                  <p class="lead text-muted">Find all the latest Music and your Favourites collection of online music from all your favourite artists and labels. You can also search and filter through the entire catalog and create your own playlists.</p>
                  <p>
                     <a href="#bottom" class="btn btn-primary my-2">Explore</a>
                     <?php if (!!$Admin) { ?>
                     <a href="add.html" class="btn btn-primary my-2">Add new Music</a>
                     <?php } ?>
                  </p>
               </div>
            </section>
         ...
         <div class="container">
            ...
            <section id="bottom" class="jumbotron bottom-section flex flex-column full-width text-center my-0">
               <h2 class="justify-content-center">All Tracks</h2>
               <form class="form-inline mb-4 mb-lg-4 justify-content-center">
                  <input class="form-control ml-sm-2 " type="text" placeholder="Search Tracks,Album,Artists,year etc." id="txtsearch" aria-label="Search">
                  &nbsp;&nbsp;
